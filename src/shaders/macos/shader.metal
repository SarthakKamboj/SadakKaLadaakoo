...
vs_out_t vertex vertex_main(
    ...
    out.position = uniform_data->ndc_mat * uniform_data->pers_mat * uniform_data->world_mat * float4(vertices[vertexId].pos.x, vertices[vertexId].pos.y, vertices[vertexId].pos.z, 1.0);
